...
| 2      | JavaScript   |  <img src='https://logodownload.org/wp-content/uploads/2022/04/javascript-logo-4.png' width="200px"/>      | Lenguaje         | En si es el lenguaje mas utilizado para realizar proyectos dentro de node, debido a que este entorno "Back-End" es muy utilizado para controlar el negocio por detras de las vistas "Ejs" ademas de que tambien fue de utilidad para el entorno de los modelos de base de datos "Mongoose". |      18.16.0              |
...
| 4      | Node.js     |    <img src='https://www.startechup.com/wp-content/uploads/January-11-2021-Nodejs-What-it-is-used-for-and-when-where-to-use-it-for-your-enterprise-app-development.jpg' width="200px"/>                    | Entorno          | Empleado para la ejecución de código JavaScript del lado del servidor. Como ya se ha mencionado anterior mente, este entorno es muy facil para usar en casi cualquier software que no requiera de tantos requerimientos. Ademas su adaptibilidad con cualquier entorno de capa de presentacion es muy factible(Front-End) |     18.16.0       |
...
| 6     | MongoDB    |   <img src='https://repvue.imgix.net/a9yxc48y3ay5dm2udzwizc2bdyph' width="200px"/>                        | Base de Datos    | Tiene su propio servicio en la nube,  es por ello que se eligio ya que Mongo Atlas tiene un cluster publico para almacenar cualquier base de datos que se desee. Ademas de que con las tecnologias como Node, hacen mas facil su uso debido que dentro de los controladores, solo es necesario de declarar un mapeo de los documentos que se almacenarar dentro de las colecciones.         |       5.12.8              |
